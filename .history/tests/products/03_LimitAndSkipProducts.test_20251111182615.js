...
describe('Limit and skip products', function () {
	...
	it('1.2 → Response should contain  products', function () {
		expect(resLimitSkip.body).to.have.property('products').that.is.an('array');
		// .with.lengthOf(5);
		console.log('Products length:', resLimitSkip.body.products.length);
	});
});
